            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block">Intelligent Health</span>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <h3 className="ml-16 text-lg leading-6 font-medium text-gray-900">Track Your Health Data</h3>
                </div>
                <div className="mt-2 ml-16">
                  <p className="text-base text-gray-500">
                    Record and analyze key health metrics like weight, height, BMI, and blood pressure
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <h3 className="ml-16 text-lg leading-6 font-medium text-gray-900">Create Personalized Exercise Plans</h3>
                </div>
                <div className="mt-2 ml-16">
                  <p className="text-base text-gray-500">
                    AI will design the most suitable exercise program based on your physical condition and goals
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <h3 className="ml-16 text-lg leading-6 font-medium text-gray-900">Smart Health Analysis</h3>
                </div>
                <div className="mt-2 ml-16">
                  <p className="text-base text-gray-500">
      ...
      <div className="bg-indigo-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-indigo-600">Register now to get started.</span>
          </h2>
